    ...
    <section id="create" class="create">
        <div class="container">
            <div class="row">
                <div class="col-8">
                    <div class="row mb-3">
                        <h2><strong>Form Edit Jersey</strong></h2>
                    </div>
                    <div class="row">
                        <?php $validation = \Config\Services::validation(); ?>
                        <form action="/jersey/update/<?= $jersey['id']; ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10 mb-3">
                                    <input type="text" class="form-control <?= ($validation->hasError('judul')) ? 'is-invalid' : ''; ?>" id="judul" name="judul" value="<?= $jersey['judul']; ?>" autofocus>
                                ...
                                <div class="col-sm-10 mb-3">
                                    <select class="form-select <?= ($validation->hasError('id_klub')) ? 'is-invalid' : ''; ?>" id="id_klub" name="id_klub">
                                        ...
                                        <?php foreach ($Klub as $k) : ?>
                                            <option value="<?= $k['id_klub']; ?>" <?= old('id_klub', $jersey['id_klub']) == $k['id_klub'] ? 'selected' : ''; ?>><?= $k['nama']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-sm-10 mb-3">
                                    <select class="form-select <?= $validation->hasError('apparel_sampul') ? 'is-invalid' : ''; ?>" id="apparel_sampul" name="apparel_sampul">
                                        ...
                                        <?php foreach ($Apparel as $a) : ?>
                                            <option value="<?= $a['sampul']; ?>" <?= old('apparel_sampul', $jersey['apparel']) == $a['sampul'] ? 'selected' : ''; ?>><?= $a['nama']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <div class="invalid-feedback">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10 mb-3">
                                    <input type="number" class="form-control <?= $validation->hasError('harga') ? 'is-invalid' : ''; ?>" id="harga" name="harga" value="<?= $jersey['harga']; ?>">
                                    <div class="invalid-feedback">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10 mb-3">
                                    <input type="number" class="form-control <?= $validation->hasError('ketersediaan') ? 'is-invalid' : ''; ?>" id="ketersediaan" name="ketersediaan" value="<?= $jersey['ketersediaan']; ?>">
                                    <div class="invalid-feedback">
