...
<!-- Vendor JS Files -->
<script src="<?= base_url('Front-end') ?>/assets/vendor/purecounter/purecounter_vanilla.js">
</script>
<script src="<?= base_url('Front-end') ?>/assets/vendor/aos/aos.js"></script>
<script src="<?= base_url('Front-end') ?>/assets/vendor/bootstrap/js/bootstrap.bundle.min.js">
</script>
